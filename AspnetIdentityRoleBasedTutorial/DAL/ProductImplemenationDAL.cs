...
namespace OnlineShoppingProject.DAL
{
   public class ProductImplemenationDAL
   {
      ...
      //GetParticularProductRecord
      public async Task<List<TblProduct>> GetProductDetailDAL(int id)
      {
         return await _context.TblProducts.Where(r => r.ProductId == id).ToListAsync();
      }
